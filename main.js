...
let menuElement = document.querySelector("#drawer-right-example");
...
function addHeaderBlur() {
  if (document.documentElement.classList.contains("dark")) {
    document
      .getElementById("headerElement")
      .classList.replace("dark:bg-[#091021]", "dark:bg-[#0f1627]");
    document.getElementById("logoCover").classList.add("bg-[#0f162780]");
  } else {
    document
      .getElementById("headerElement")
      .classList.replace("bg-white", "bg-[#888c94]");
...
function eraseHeaderBlur() {
  if (document.documentElement.classList.contains("dark")) {
    document
      .getElementById("headerElement")
      .classList.replace("dark:bg-[#0f1627]", "dark:bg-[#091021]");
    document.getElementById("logoCover").classList.remove("bg-[#0f162780]");
  } else {
    document
      .getElementById("headerElement")
      .classList.replace("bg-[#888c94]", "bg-white");
...
function closeSideMenuOnHyperLink() {
  document
    ...
    .classList.replace("transform-none", "translate-x-full");
  ...
  if (document.documentElement.classList.contains("dark")) {
    document
      .getElementById("headerElement")
      .classList.replace("bg-[#0f1627]", "bg-[#091021]");
    document.getElementById("logoCover").classList.remove("bg-[#0f162780]");
  } else {
    document
      .getElementById("headerElement")
...
function switchDarkMode() {
  if (menuElement.getAttribute("aria-hidden")) {
